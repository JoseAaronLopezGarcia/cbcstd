...
#ifndef CBC_STACKTRACE_H
#define CBC_STACKTRACE_H

#include <cbcstd.h>

extern void cbc_addStackTrace(char** trace);
extern void cbc_printThreadStackTrace(void*);
extern void cbc_printCurrentStackTrace();
